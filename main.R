...
names(lon)<-"lon"
names(lat)<-"lat"
writeRaster(mean_observations, dump_file_mprs_apgd, overwrite=TRUE, format="CDF",
...
lon <- raster(getEUR11regridded_eval_pr()[[1]], varname="lon")
lat <- raster(getEUR11regridded_eval_pr()[[1]], varname="lat")
eval_eur11 <- stackSim(getEUR11regridded_eval_pr(), varname = "pr", factor = 3600*24)
mean_eval_eur11<-getAnnualMeanSim(eval_eur11)
mean_mean_eval_eur11 <- calc(mean_eval_eur11, fun=mean)
extent(mean_mean_observations)<-extent(mean_mean_eval_eur11)
dif_mean_eval_eur11<-overlay(mean_mean_eval_eur11, mean_mean_observations,fun=function(x,y){return((x - y))})
...
lon <- raster(getEUR11regridded_historical_pr()[[1]], varname="lon")
lat <- raster(getEUR11regridded_historical_pr()[[1]], varname="lat")
hist_eur11 <- stackSim(getEUR11regridded_historical_pr(), varname = "pr", factor = 3600*24)
mean_hist_eur11<-getAnnualMeanSim(hist_eur11)
mean_mean_hist_eur11 <- calc(mean_hist_eur11, fun=mean)
extent(mean_mean_observations)<-extent(mean_mean_hist_eur11)
dif_mean_hist_eur11<-overlay(mean_mean_hist_eur11, mean_mean_observations,fun=function(x,y){return((x - y))})
...
lon <- raster(getALP3regriddedevalPR()[[1]], varname="lon")
lat <- raster(getALP3regriddedevalPR()[[1]], varname="lat")
eval_alp3 <- stackSim(getALP3regriddedevalPR(), varname = "TOT_PREC", factor = 1)
mean_eval_alp3<-getAnnualMeanSim(eval_alp3)
mean_mean_eval_alp3 <- calc(mean_eval_alp3, fun=mean)
extent(mean_mean_observations)<-extent(mean_mean_eval_alp3)
dif_mean_eval_alp3<-overlay(mean_mean_eval_alp3, mean_mean_observations,fun=function(x,y){return((x - y))})
...
lon <- raster(getALP3regriddedhistPR()[[1]], varname="lon")
lat <- raster(getALP3regriddedhistPR()[[1]], varname="lat")
hist_alp3 <- stackSim(getALP3regriddedhistPR(), varname = "TOT_PREC", factor = 1)
mean_hist_alp3<-getAnnualMeanSim(hist_alp3)
mean_mean_hist_alp3 <- calc(mean_hist_alp3, fun=mean)
extent(mean_mean_observations)<-extent(mean_mean_hist_alp3)
dif_mean_hist_alp3<-overlay(mean_mean_hist_alp3, mean_mean_observations,fun=function(x,y){return((x - y))})
...
eval_eur11_temp<-stackSim(getEUR11regridded_eval_temp(), varname="tas", factor = 1)
hist_alp3_temp<-stackSim(getALP3regriddedhistTEMP(), varname="T_2M", factor=1) #NO MISSING VALUE
eval_alp3_temp<-stackSim(getALP3regriddedevalTEMP(), varname="T_2M", factor = 1) #NO MISSING VALUE
...
extent(quantile_observations)<-extent(quantile_eval_eur11)
dif_quantile_eval_eur11 <- overlay(quantile_eval_eur11, quantile_observations, fun=function(x,y){return((x - y))})
